...
export class AutopostCoverImage extends Component {
  state = {
    uploadError: false,
    ...
    return (
      ...
      >
        <div className="crayons-article-form__cover" role="presentation">
          ...
          {uploadError && (
            <p className="autopostform__uploaderror">{uploadErrorMessage}</p>
          )}
        </div>
      </DragAndDropZone>
    );
...
AutopostCoverImage.propTypes = {
  mainImage: PropTypes.string,
  onMainImageUrlChange: PropTypes.func.isRequired,
};

AutopostCoverImage.displayName = 'AutopostCoverImage';
