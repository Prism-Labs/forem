...
describe('<Help />', () => {
  ...
  it('does not render help if we are in preview mode', () => {
    ...
    expect(queryByTestId('autopost-form__help-section')).toBeNull();
  });
  ...
  it('shows help for the given section when in edit mode', () => {
    ...
    getByTestId('autopost-form__help-section');
  ...
  it('shows the correct help for v1', () => {
    ...
    queryByTestId('autopost-form__help-section');
  ...
  describe('with the appropriate v2 help sections', () => {
    it('shows the autopost-form-title', () => {
      const { queryByTestId } = render(
        <Help
          previewShowing={false}
          helpFor="autopost-form-title"
    ...
    it('shows the autopost_body_markdown', () => {
      const { queryByTestId } = render(
        <Help
          previewShowing={false}
          helpFor="autopost_body_markdown"
          helpPosition={null}
          version="v2"
        />,
      );
